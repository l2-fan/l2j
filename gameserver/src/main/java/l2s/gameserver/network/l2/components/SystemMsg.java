...
public enum SystemMsg implements IBroadcastPacket
{
	...
	// Message: Thank you for recapturing the fortress invaded by orcs. Here is your reward for displaying a flag. -Fortress Manager-
	...
	// Message: The character is not a mercenary anymore, because his/ her clan takes part in the Siege.
	...
	// Message: You cannot file a mercenary request to a clan, which has not receive the right to defend the Castle.
	...
	// Message: Mercenary application/application cancellation is being processed. Try again after the process ends.
	...
	// Message: Your character does not meet the level requirements to be a mercenary.
	YOUR_CHARACTER_DOES_NOT_MEET_THE_LEVEL_REQUIREMENTS_TO_BE_A_MERCENARY(13044),
	// Message: A character, which is a member of a party, cannot file a mercenary request.
	A_CHARACTER_WHICH_IS_A_MEMBER_OF_A_PARTY_CANNOT_FILE_A_MERCENARY_REQUEST(13045),
	// Message: One of the characters on your account is a mercenary. Only one character can be a mercenary.
	...
	// Message: You cannot hire mercenaries from a clan, which has announced or started a war or declared a cease-fire.
	...
	// Message: If a clan has not received the right to defend the Castle, it cannot hire mercenaries.
	IF_A_CLAN_HAS_NOT_RECEIVED_THE_RIGHT_TO_DEFEND_THE_CASTLE_IT_CANNOT_HIRE_MERCENARIES(13061),
	// Message: You cannot use Forced Attack on the members and mercenaries of your own clan.
	YOU_CANNOT_USE_FORCED_ATTACK_ON_THE_MEMBERS_AND_MERCENARIES_OF_YOUR_OWN_CLAN(13031),
	// Message: It is possible to forcibly attack other characters and mercenaries from other clan, even if it's an ally clan.
	...
	// Message: $s1, to my regret we cannot reward you for your services as a mercenary. I hope you will have more luck in the battles to come.\n- Giran Castle Lord-
	...
	// Message: Unable to open Olympiad Screen while in participating or watching a match.
	...
	// Message: $c1 does not meet the participation requirements as the inventory weight / slot is filled beyond 80%%.
	...
	// Message: You have reached the maximum number of My Teleport slots or use conditions are not observed.
	...
	// Message: In $s1 sec. you will be taken to the Olympic Stadium for the 3 vs 3 competitions.
	...
	// Message: $c1 is currently teleporting and cannot participate in the 3 vs 3 Olympiad.
	...
	// Message: You cannot send a whisper to someone who is participating in the 3 vs 3 Olympiad.
	YOU_CANNOT_SEND_A_WHISPER_TO_SOMEONE_WHO_IS_PARTICIPATING_IN_THE_3_VS_3_OLYMPIAD(13131),
	// Message: You will be teleported in Team Match within 10 seconds. From that moment, you cannot withdraw.
	...
	// Message: You've received the consolation prize for participating in the 3 vs 3 Olympiad.
	...
	// Message: The Secret Supplies of the Balthus Knights arrived! Someone received $s1.
