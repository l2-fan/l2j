...
import l2s.gameserver.network.l2.c2s.collection.*;
import l2s.gameserver.network.l2.c2s.itemrestore.*;
import l2s.gameserver.network.l2.c2s.randomcraft.*;
import l2s.gameserver.network.l2.c2s.spectating.*;
import l2s.gameserver.network.l2.c2s.subjugation.*;
						...
						case 0xd0:
							...
							switch(id3)
							{
								...
								case 0x1CC:
									...
									break;
								case 0x1CD:
									//_log.warn("received 0x1CD");
									break;
								case 0x1CE:
									//_log.warn("received 0x1CE");
									break;
								case 0x1CF:
									//_log.warn("received 0x1CF");
									break;
								case 0x1D0:
									//_log.warn("received 0x1D0");
									break;
								case 0x1D1:
									//_log.warn("received 0x1D1");
									break;
								case 0x1D2:
									//_log.warn("received 0x1D2");
									break;
								case 0x1D3:
									//_log.warn("received 0x1D3");
									break;
								case 0x1D4:
									//_log.warn("received 0x1D4");
									break;
								case 0x1D5:
									//_log.warn("received 0x1D5");
									break;
								case 0x1D6:
									//_log.warn("received 0x1D6");
									break;
								case 0x1D7:
									//_log.warn("received 0x1D7");
									break;
								case 0x1D8:
									//_log.warn("received 0x1D8");
									break;
								case 0x1D9:
									//_log.warn("received 0x1D9");
									break;
								case 0x1DA:
								...
								case 0x1E3:
									...
									break;
								case 0x1E4:
									// C_EX_PVPBOOK_SHARE_REVENGE_KILLER_LOCATION
									msg = new RequestExPvpBookShareRevengeKillerLocation();
									break;
								case 0x1E5:
									// C_EX_PVPBOOK_SHARE_REVENGE_TELEPORT_TO_KILLER
								...
								case 0x1EF:
									...
									break;
								case 0x1F0:
									msg = new RequestExSubjugationGachaUI();
									break;
								case 0x1F1:
