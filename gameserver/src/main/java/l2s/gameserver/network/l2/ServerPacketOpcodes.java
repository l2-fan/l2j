...
public enum ServerPacketOpcodes
{
	...
	/*0xFE:0x29F*/	ExDroppedItemLoc, // S_EX_PENALTY_ITEM_DROP? TODO: find packet name
	/*0xFE:0x2A0*/	ExItemRestoreList,
	/*0xFE:0x2A1*/	ExItemRestore,
	/*0xFE:0x2A2*/	ExUserWatcherTargetList,
	/*0xFE:0x2A3*/	ExUserWatcherTargetStatus,
	/*0xFE:0x2A4*/	ExUnk2A4,
	/*0xFE:0x2A5*/	ExUnk2A5,
	/*0xFE:0x2A6*/	ExUnk2A6,
	/*0xFE:0x2A7*/	ExItemsToRestore, // announce amount items to restore TODO: find packet name
	/*0xFE:0x2A8*/	ExUnk2A8,
	//
