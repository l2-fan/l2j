...
public class GameServer
{
	...
	public static final String PROJECT_REVISION = "L2s [38455]";
	public static final String UPDATE_NAME = "Classic: The Great Collector (306)";
	...
	public GameServer() throws Exception
	{
		...
		if(Config.SERVICES_OFFLINE_TRADE_RESTORE_AFTER_RESTART)
		{
			...
			ThreadPoolManager.getInstance().schedule(() -> TradeHelper.restoreOfflineTraders(), 30000L);
