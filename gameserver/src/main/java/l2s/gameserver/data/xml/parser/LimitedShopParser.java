...
public class LimitedShopParser extends AbstractParser<LimitedShopHolder>
{
	...
	{
		if (Config.DEFAULT_LANG == Language.RUSSIAN)
			return new File(Config.DATAPACK_ROOT, "data/limitedShop/ru");
		else if (Config.DEFAULT_LANG == Language.ENGLISH_EU)
			return new File(Config.DATAPACK_ROOT, "data/limitedShop/eu");
		else if (Config.DEFAULT_LANG == Language.CHINESE_TW)
			return new File(Config.DATAPACK_ROOT, "data/limitedShop/tw");
		else
			return new File(Config.DATAPACK_ROOT, "data/limitedShop/eu");
	}
